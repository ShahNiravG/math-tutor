...
class Amc10ScraperTests(unittest.TestCase):
    ...
    def test_scrape_amc10_exam_from_html_builds_explicit_exam_with_metadata_images_and_links(self) -> None:
        ...
        self.assertEqual(exam["bank"], "amc10")
        self.assertEqual(exam["bank_title"], "AMC 10")
        self.assertEqual(exam["id"], "amc10-2025-amc-10a")
        ...
        self.assertEqual(first_question["id"], "amc10-2025-amc-10a-q01")
        ...
        self.assertEqual(second_question["id"], "amc10-2025-amc-10a-q02")
        ...
        self.assertEqual(third_question["id"], "amc10-2025-amc-10a-q03")
    ...
    def test_sync_curated_exam_bundle_preserves_explicit_amc10_exam_ids(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            (exams_dir / "amc10_2025_amc_10a.json").write_text(
            ...
            self.assertEqual([item["id"] for item in bundle["exams"]], ["amc10-2025-amc-10a"])
            self.assertEqual(bundle["exams"][0]["questions"][0]["id"], "amc10-2025-amc-10a-q01")
            self.assertEqual(bundle["exams"][0]["questions"][1]["id"], "amc10-2025-amc-10a-q02")
            self.assertEqual(bundle["exams"][0]["questions"][2]["id"], "amc10-2025-amc-10a-q03")
...
class OptionParsingTests(unittest.TestCase):
    def test_parse_option_alt_handles_space_before_brace(self) -> None:
        ...
        from math_tutor.amc10_scraper import _parse_option_alt
...
class ForceRescrapeTests(unittest.TestCase):
    def test_scrape_all_cli_rejects_force_flag(self) -> None:
        import subprocess
        import sys
        result = subprocess.run(
            [sys.executable, "-m", "math_tutor.amc10_scraper", "scrape-all", "--force", "/tmp/out"],
            capture_output=True,
        )
        self.assertNotEqual(result.returncode, 0, "scrape-all --force should be rejected by the CLI")

    def test_preserve_question_ids_reuses_existing_id_when_text_matches(self) -> None:
        from math_tutor.amc10_scraper import _preserve_question_ids
