...
class ArtifactPathsTests(unittest.TestCase):
    ...
    def test_build_prompt_paths_for_default_gpt_prompt_uses_explicit_model_suffix(self) -> None:
        ...
        self.assertEqual(md_path, Path("output/responses/4401267_alg-2trig-h-chp-5-1-note-docx__inspiring-videos-gpt4.md"))
        self.assertEqual(html_path, Path("output/responses/4401267_alg-2trig-h-chp-5-1-note-docx__inspiring-videos-gpt4.html"))
        self.assertEqual(pdf_path, Path("output/responses/4401267_alg-2trig-h-chp-5-1-note-docx__inspiring-videos-gpt4.pdf"))
        self.assertEqual(metadata_path, Path("output/metadata/4401267_alg-2trig-h-chp-5-1-note-docx__inspiring-videos-gpt4.json"))
