...
CORE_MODULES = [
    ...
    "math_tutor/challenge_config.py",
    "math_tutor/chaptering.py",
    "math_tutor/challenge_builder.py",
    "math_tutor/challenge_outputs.py",
    ...
    "math_tutor/mcq_artifacts.py",
    "math_tutor/mcq_clients.py",
    "math_tutor/mcq_generator.py",
    "math_tutor/mcq_prompts.py",
    "math_tutor/mcq_workflow.py",
